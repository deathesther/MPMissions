...
if (!isDedicated) then {
	...
	player_fired =				compile preprocessFileLineNumbers "custom\Various_Scripts\player_fired.sqf";			//Runs when player fires. Alerts nearby Zeds depending on calibre and audial rating
	...
	player_spawn_2 =			compile preprocessFileLineNumbers "custom\dayz_code\systems\player_spawn_2.sqf";

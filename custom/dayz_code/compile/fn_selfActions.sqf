...
// ZOMBIE SHIELD START
if (("PartGeneric" in magazines player) && ("PartFueltank" in magazines player) && ("PartEngine" in magazines player) && ("ItemJerrycan" in magazines player) && ("ItemToolbox" in items player)) then {
    hasShield = true;
} else {
    hasShield = false;
};
if (hasShield) then {
    ...
    zombieShield = player addAction [("<t color=""#00c362"">" + ("Anti-Zombie Freq Emitter") +"</t>"),"custom\Various_Scripts\zombieshield.sqf","",5,false,true,"",""];
    };
} else {
...
zombieBait = player addAction [("<t color=""#c30000"">" + ("Place Zombie Bait") +"</t>"),"custom\zombiebait\zombiebait.sqf","",5,false,true,"",""];
    };
} else {
...
zombieBomb = player addAction [("<t color=""#c30000"">" + ("Place Exploding Bait") +"</t>"),"custom\zombiebait\zombiebomb.sqf","",5,false,true,"",""];
};
} else {
